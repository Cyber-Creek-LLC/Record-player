module.exports = {
	...
	supportServer: "https://discord.gg/Gb6NBPpSSh", //- Support Server Link
	Issues: "https://github.com/Cyber-Creek-LLC/Record-player/issues", //- Bug Report Link
	...
	// You need a lavalink server for this bot to work. Thats why I have left in my free public lavalink server
	// Lavalink server; public lavalink -> https://lavalink-list.darrennathanael.com/; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
	nodes: [
		{
			identifier: "Main Node", //- Used for indentifier in stats commands.
			host: "5.78.68.68", //- The host name or IP of the lavalink server.
			port: 2002, // The port that lavalink is listening to. This must be a number!
			password: "jla3109Kas", //- The password of the lavalink server.
